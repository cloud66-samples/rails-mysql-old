...
custom_web: A=$RAILS_ENV B=${RAILS_ENV} C=${RAILS_ENV:-test} bundle exec puma -e ${RAILS_ENV:-production} --preload
web: A=$RAILS_ENV B=${RAILS_ENV} C=${RAILS_ENV:-test} bundle exec puma -e ${RAILS_ENV:-production} --preload
